...
export default function InitialLoadingScreen() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      // First, start the fade-out after 2.5 seconds
      const fadeTimer = setTimeout(() => {
        setFadeOut(true)
      }, 2500)

      // Then, completely remove the component after the fade-out animation completes
      const removeTimer = setTimeout(() => {
        setVisible(false)
      }, 3500) // 2.5s delay + 1s for fade-out animation
