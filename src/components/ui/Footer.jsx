        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/mental-health-checkin" className="text-gray-400 hover:text-white transition-colors">
                  Daily Check-in
                </Link>
              </li>
              <li>
                <Link href="/book-session" className="text-gray-400 hover:text-white transition-colors">
                  Book a Session
                </Link>
              </li>
              <li>
