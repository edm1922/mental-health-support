...
function generateResponse(message, emotion, userName = null) {
  ...
  switch(emotion) {
    ...
    case 'neutral':
      return `${greeting}! I'm your Emotion AI Assistant powered by DeepSeek-V3 (fallback mode). How are you feeling today?`;
    ...
    default:
      return `${greeting}! I'm your Emotion AI Assistant powered by DeepSeek-V3 (fallback mode). I'm here to chat and provide support. How can I help you today?`;
  }
}
