...
export default function CounselorApplicationPage() {
  ...
  useEffect(() => {
    if (!userLoading && !user) {
      ...
      router.push('/account/signin?redirect=/apply-as-counselor');
    }
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <Link
            href="/account/signin?redirect=/apply-as-counselor"
  ...
  if (isCounselor) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
        <Navbar />
        <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl mt-20">
