...
export default function CounselorApplicationPage() {
  ...
  useEffect(() => {
    if (!userLoading && !user) {
      // Redirect to the special counselor sign-in page
      console.log("Redirecting to counselor sign-in page");
      window.location.href = '/counselor/signin';
    }
  }, [user, userLoading]);
  ...
  if (hasApplied || success) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl">
          <h1 className="mb-4 text-2xl font-bold text-gray-800">Application Pending</h1>
          <p className="mb-6 text-gray-600">
            Thank you for applying to be a counselor on our platform. Your application is currently pending review by our admin team. We'll notify you by email when your status changes.
          </p>
            ...
            {error && (
              <div className="rounded-lg bg-red-50 p-4 text-red-500">
                ...
                {error.includes('Authentication') && (
                  <div className="mt-2">
                    <Link
                      href={`/account/signin?redirect=${encodeURIComponent(window.location.pathname + window.location.search)}`}
